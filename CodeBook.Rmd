...
---
#Introduction
The data for this dataset was gethered from an experiemnt that is attrivbuted at the end of this document. The following is from their readme;
...
This derived dataset is made up of 180 rows of 68 variables. The rows are summaries of the original dataset.
THe features are means of the experiemtnal data gathere. The data variables defined in the this way;
##Variables
...
-- All variables except the first two ActivityNbr and SubjectNbr were prefixed with "M" denoting that they are Means.
